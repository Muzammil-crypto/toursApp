...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibXNhZnlhbjA4MCIsImEiOiJjazg0YzE0aGoxa3I0M2xsbm44aHdmMnpzIn0.ZFV2z77B9WcmHx3tqtT_-g';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/msafyan080/ck8k0crtb0s801ioczllbxcok' // center: [74.308801, 31.42813],
    // scrollZoom:false,
    // zoom: 8
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: ele,
      anchor: 'bottom'
    }).setLonLat(loc.coordinates).addTo(map); //Add popup
...
console.log('hello from index.js header'); // DOM ELEMENTS
...
if (loginForm) loginForm.addEventListener('submit', function (e) {
  ...
  console.log('hello from index loginForm');
